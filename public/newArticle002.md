...
tags:
  ...
  - VSCode
private: false
updated_at: '2025-08-08T08:44:21+09:00'
...
VS Codeの標準的な機能や代表的なMarkdownの拡張機能で引用表示[^1]の変換実現できないか試行錯誤しましたが、良い方法が見つかりませんでした。
深掘りして調べて、いくつか良さそうな方法があったので共有します。

[^1]: 引用表示: 厳密にはMarkdownであれば、ブロッククオート（Block Quote）や引用ブロックと表現するのが正しいが便宜上、この記事では**引用表示**と呼称しています。
